...
(function() {
  ...
  const { getActiveOfferingId, getOfferingWithStats, updateCourseInfo, updateCourseProgress, updateStickyHeader, updateWelcomeMessage, getAnnouncements } = window.DashboardService;

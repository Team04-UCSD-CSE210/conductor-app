...
**Solution:** Copy the `loadRecentProgress()` function from
`student-leader-dashboard.js` to other dashboard JS files
...
**Issue:** Shows "Insert course description" as placeholder
